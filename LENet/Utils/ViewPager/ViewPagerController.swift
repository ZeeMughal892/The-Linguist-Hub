...
public class ViewPagerController:UIViewController {
    ...
    fileprivate func setupTabContainerView() {
        ...
        tabContainer.backgroundColor = .systemBackground
        tabContainer.isScrollEnabled = false
    ...
    fileprivate func setupPageControllerFrame() {
        ...
        let viewPagerFrame = options.viewPagerFrame
        let viewPagerHeight = options.viewPagerFrame.height - options.tabViewHeight - options.viewPagerFrame.origin.y - 60
